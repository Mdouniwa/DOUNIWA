...
肌は磁器のように白く透明感のある質感。血色を抑え、内側からほのかに光るような白さで、
頬の赤みは最小限にすること。
目は切れ長のアーモンド型。大きく見開いた丸い目にはせず、涼しげで知的な目元にする。
輪郭は細面。丸顔ではなく、顎のラインがすっきりした面長。
全体に儚げで神秘的な雰囲気。健康的で快活な印象ではなく、静かで少し憂いのある佇まい。
清楚で品があり、やさしく穏やかであること。
...
const EXPRESSIONS = [
  ['normal', 'やさしく微笑んで、リラックスして立っている'],
  ['happy', 'とてもうれしそうに目を細めて笑い、両手を胸の前で軽くあわせている'],
  ['thinking', '人差し指をあごにあて、少し首をかしげて考えている'],
  ['surprised', '目をまるくして、口を小さくあけておどろいている'],
  ['cheer', '両手を高く挙げて応援している。まわりにキラキラの光'],
];
